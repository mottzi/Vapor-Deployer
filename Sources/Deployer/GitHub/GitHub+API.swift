...
extension GitHub {
    ...
    /// Thin REST wrapper that centralizes API-version pinning, header setup, status checking, and JSON decoding.
    enum API {
        ...
        static func request(
            ...
            request.setValue(GitHub.acceptHeader, forHTTPHeaderField: "Accept")
            request.setValue(GitHub.apiVersion, forHTTPHeaderField: "X-GitHub-Api-Version")
            if body != nil {
...
extension GitHub.API {
    ...
    enum Error: LocalizedError {
        ...
        var errorDescription: String? {
            switch self {
                case .requestFailed(let message): "GitHub API request failed: \(message)"
                case .invalidURL(let rawURL): "GitHub API request failed: invalid URL '\(rawURL)'"
            }
        }
