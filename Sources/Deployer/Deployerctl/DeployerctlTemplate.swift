...
enum DeployerctlTemplate {
  ...
  static func wrapperScript() -> String {
    ...
    for _var in SERVICE_USER SERVICE_BACKEND PRODUCT_NAME INSTALL_DIR APP_DIR DEPLOYER_LOG APP_LOG; do
    ...
    case "$SERVICE_BACKEND" in
      ...
      supervisor)
        ...
        ;;
      *) die "unknown SERVICE_BACKEND in $CONFIG_FILE: $SERVICE_BACKEND" ;;
    esac
    """
  }
