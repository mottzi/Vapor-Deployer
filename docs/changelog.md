...
- Route self-update system logs to the shared `deployer.log` file without leaking them into the operator-facing CLI transcript, while still printing concise command failures to the operator.
